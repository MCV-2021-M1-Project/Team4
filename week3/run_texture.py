...
from textureDescriptors import texture_descriptors
...
def parse_args():
    ...
    parser.add_argument('-t', type=str, default='dct',
                        help='Type of color descriptor to use.')
...
def main():
    ...
    for i in range(n_bbdd_images):
        ...
        bbdd_hists.append(texture_descriptors(img, type=args.t))
    ...
    for i in range(n_query_images):
        ...
        query_hist = texture_descriptors(img, type=args.t)
    ...
    print()
    print(f'mAP@k (k = {args.k}) using {args.t} and hellinger distances:')
