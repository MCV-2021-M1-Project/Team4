...
# FILE WITH ALL THE FUNCTIONS WHICH DEAL WITH DETECTING THE TEXT BOX OF A PAINTING
...
def bounding_box(img, mask=None):
    ...
    text_mask = cv2.morphologyEx(text_mask, cv2.MORPH_OPEN, np.ones(
    ...
    blackhat_box[top:bottom, 115: -115] = blackhat[top:bottom,
                                          15:width - 15]  # We do not take values from the edges of the image, as textbox i in the center
